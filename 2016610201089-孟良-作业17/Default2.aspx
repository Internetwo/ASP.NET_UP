                    ...
                    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                        <asp:View ID="View1" runat="server">
                            <table align="center" cellpadding="0" cellspacing="0" class="style3">
                                <tr>
                                    <td class="style5">
                                        准考证号：<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox><asp:RequiredFieldValidator 
                                            ID="RequiredFieldValidator1" runat="server" BorderStyle="None" 
                                            ControlToValidate="TextBox1" ErrorMessage="请输入有效数值！"></asp:RequiredFieldValidator></td>
                                </tr>
                                <tr>
                                    <td class="style4">
                                        身份证号：<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox><asp:RequiredFieldValidator 
                                            ID="RequiredFieldValidator2" runat="server" BorderStyle="None" 
                                            ControlToValidate="TextBox2" ErrorMessage="请输入有效数值！"></asp:RequiredFieldValidator></td>
                                </tr>
                                <tr>
                                    <td class="style5">
